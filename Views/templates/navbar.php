...
<div class="wrapper">
    <aside id="sidebar">
        ...
        <ul class="sidebar-nav">
            ...
            <!--ALARMAS-->
            <li class="sidebar-item">
                <a href="<?php echo base_url?>Alarmas" class="sidebar-link" hidden>
                    <i class="ri-alarm-warning-fill"></i>
                    <span class="text-uppercase">Alarmas</span>
                </a>
            </li>
            <!-- MENSAJES-->
            <li class="sidebar-item">
                <a href="<?php echo base_url?>Mensajes" class="sidebar-link" hidden>
                    <i class="ri-message-2-fill"></i>
                    <span class="text-uppercase">Mensajes</span>
                </a>
            </li>
            <!-- GPS -->
            <li class="sidebar-item">
                <a href="<?php echo base_url?>Gps" class="sidebar-link">
                    <i class="ri-map-pin-line"></i>
                    <span class="text-uppercase">GPS</span>
                </a>
            </li>
            <!-- ALERTAS -->
            <li class="sidebar-item">
                <a href="<?php echo base_url?>Alertas" class="sidebar-link">
                    <i class="ri-alert-fill"></i>
                    <span class="text-uppercase">Alertas</span>
                </a>
            </li>
            <!-- GRÁFICO -->
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
                <a href="<?php echo base_url?>Mantenimiento" class="sidebar-link">
                    ...
                    <span class="text-uppercase">Mantenimiento</span>
                </a>
            </li>
            <!-- USUARIOS -->
            ...
            <li class="sidebar-item">
                ...
                <ul id="report" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                    <li class="sidebar-item">
                        <a href="<?php echo base_url?>Reporte" class="sidebar-link">Día</a>
                    </li>
                </ul>
            </li>
          ...
          <!-- SEARCH BOX
                    ...
                    -->
    <div class="main">
        <nav class="navbar navbarLight navbar-expand navbar-light d-flex justify-content-between ">
            ...
            <ul class="navbar-nav d-flex justify-content-end align-items-center navbarIcon">
                ...
                <ul class="dropdown-menu dropdown-menu-end border-0 shadow bsb-zoomIn" aria-labelledby="profileDropdown" >
                    <li><a class="dropdown-item" href="<?php echo base_url; ?>Perfil/perfil">Perfil</a></li>
